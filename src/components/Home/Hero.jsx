  ...
  return (
    <section className="container py-10 md:py-20">
      <div className="flex justify-center flex-col md:flex-row ">
        <div>
          <img
            className="w-[500px] md:w-[691px] md:h-[691px] md:object-cover "
            src={gif}
            alt=""
          />
        </div>
        <div className="">
          <h2 className="text-2xl text-center md:text-left font-semibold  md:ml-20 secfont">
            Introducing
          </h2>
          <div className="mb-3 flex justify-center md:justify-start">
            <img
              className=" w-[300px] md:w-[647px] md:h-[282px]  md:object-cover"
              src={img}
              alt=""
            />
          </div>
          ...
          <div className="flex justify-center md:justify-start  gap-x-4 items-center md:mx-28">
            <a href="https://t.me/bratt_on_sol" target="_blank">
